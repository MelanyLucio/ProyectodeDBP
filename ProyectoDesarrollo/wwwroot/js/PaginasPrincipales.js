...
/*Grabar especialidad - Paciente*/
function abrirGrabarPC() {
    const modal = document.getElementById("GrabarPC");
    modal.style.display = "block";
}
function cerrarGrabarPC() {
    document.getElementById("GrabarPC").style.display = "none";
}
