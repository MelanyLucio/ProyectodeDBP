...
namespace ProyectoDesarrollo.Controllers
{
    public class ProyectoController : Controller
    {
        ...
        /*Crear cita - paciente*/
        public IActionResult GrabarCitaP(Cita cita)
        {
            string usuP = TempData["usuP"] as string;
            _ICita.addC(cita);
            return Redirect($"/Proyecto/PrincipalPaciente?usuP={usuP}#ReservarCitas");
        }
        /*Crear cita - Secretaria*/
